                ...
                while ($row = mysqli_fetch_assoc($run)) {
                    ...
                    <tbody>
                        <tr>
                            ...
                            <?php 
                            $id = $row['id'];
                            $query1 = "SELECT count(*) as total FROM movie WHERE movie.cat_id = $id";
                            ...
                            <td>
                                ...
                                <a href="editcategory.php?id=<?php echo $row['id']; ?>&forkey=<?php echo $row['category_id']; ?>&catname=<?php echo $row['category_name']; ?>" class="btn btn-outline-secondary">Edit</a>
                            </td>

                            <td>
                                <a href="viewpost.php?id=<?php echo $row['id']; ?>" class="btn btn-outline-info">View Posts</a>
                            </td>
                        </tr>
                    </tbody>
                    <?php
