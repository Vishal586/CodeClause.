...
<div class="container">
	<div class="head" style="text-align:center; padding: 10px 0px 10px 0px;">
		<h1>Genre On Cross Cinema</h1>
	</div>
	<a class="btn btn-warning text-light" href="addgenre.php" style="margin-left: 105px;">Add a Genre</a>
	<hr>
	<table class="table table-striped" style="margin-left: 105px;">
		<thead>
			<tr>
				<th scope="col">#</th>
